...
.sheets-theme .sidebar { background: #217346; color: white; border-right: none; box-shadow: 2px 0 10px rgba(0,0,0,0.1); z-index: 20; }
.sheets-theme .sidebar .nav-items button { color: white; opacity: 0.7; }
.sheets-theme .sidebar .nav-items button.active, .sheets-theme .sidebar .nav-items button:hover { opacity: 1; background: rgba(255,255,255,0.15); transform: translateY(-2px); }
.sheets-theme .top-bar h2 { color: #217346; font-weight: 700; margin: 0; letter-spacing: -0.5px; }
.sheets-theme .template-card:hover { border-color: transparent; box-shadow: 0 12px 24px rgba(33,115,70,0.15); transform: translateY(-6px); }
...
.search-wrap:focus-within { border-color: #217346; box-shadow: 0 4px 12px rgba(33,115,70,0.1); width: 400px; }
