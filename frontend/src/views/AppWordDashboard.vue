...
.word-theme .sidebar { background: #2b579a; color: white; border-right: none; box-shadow: 2px 0 10px rgba(0,0,0,0.1); z-index: 20; }
.word-theme .sidebar .nav-items button { color: white; opacity: 0.7; }
.word-theme .sidebar .nav-items button.active, .word-theme .sidebar .nav-items button:hover { opacity: 1; background: rgba(255,255,255,0.15); transform: translateY(-2px); }
.word-theme .top-bar h2 { color: #2b579a; font-weight: 700; margin: 0; letter-spacing: -0.5px; }
.word-theme .template-card:hover { border-color: transparent; box-shadow: 0 12px 24px rgba(43,87,154,0.15); transform: translateY(-6px); }
...
.search-wrap:focus-within { border-color: #2b579a; box-shadow: 0 4px 12px rgba(43,87,154,0.1); width: 400px; }
